const paidStatus = (array: any) => { 
  const paidTotal = array?.reduce((a:any, b:any) => a+(b.d_clients_application_pay.reduce((a:any, b:any) => a+(b.sum_pay || 0), 0) || 0), 0);
  const payTotal = array?.reduce((a:any, b:any) => a+b.d_clients_application_products.reduce((a:any, b:any) => a+b.total, 0), 0);
